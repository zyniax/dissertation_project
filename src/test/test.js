...
export const Test = ({setBrushExtent}) => {
    ...
    useEffect(() => {
        ...
        axios.get('http://localhost:3000/api/request/umap', {
            ...
            let node, link, edgepaths, root, halo, nodes;
             ...
             root = d3.hierarchy(response.data);
             nodes = flatten(root)
            ...
            function update() {
                ...
                nodeEnter.append('circle')
                    ...
                    .style("stroke", "#1888ff")   // set the line colour
            ...
            function color(d) {
                return d._children ? "#1888ff" // collapsed package
    ...
    return (
        <div ref={svgRef} style={{ position:'relative'}} >
            <div id="pre">
                {mouseOverNews != "" &&
                <Card border="secondary" key={1}  style={{width: '220px', marginTop: '15px', marginLeft: '15px', zIndex: '10', position:'absolute'}}>
